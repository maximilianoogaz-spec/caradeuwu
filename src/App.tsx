...
function ScheduleKisses({ back }: { back: () => void }) {
  ...
  return <Shell title="Agendar besitos" back={back}><div className="module-body"><h2 className="centered">Programa tus besitos</h2><p className="centered">Elige un día y hora para recibir tus besitos.</p>
